...
-- Contatos
INSERT INTO contato (
    id, nome, foto_url, email_principal, telefone_principal, empresa, cargo, aniversario, favorito, 
    logradouro, numero, complemento, bairro, cidade, estado, cep, notas, categoria_id
) VALUES 
(1, 'Ana Silva', 'https://exemplo.com/foto1.jpg', 'ana.silva@email.com', '11999990001', 'Empresa A', 'Analista', '1990-05-10', true,
 'Rua das Flores', '123', 'Apto 1', 'Centro', 'São Paulo', 'SP', '01000-000', 'Contato importante.', 1),
(2, 'Bruno Souza', 'https://exemplo.com/foto2.jpg', 'bruno.souza@email.com', '11999990002', 'Empresa B', 'Gerente', '1985-08-22', false,
 'Av. Brasil', '456', '', 'Jardim', 'Campinas', 'SP', '13000-000', 'Prefere contato por e-mail.', 2),
(3, 'Carla Dias', 'https://exemplo.com/foto3.jpg', 'carla.dias@email.com', '11999990003', 'Empresa C', 'Desenvolvedora', '1992-12-15', true,
